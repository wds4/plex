...
function fetchConceptGraph_ppa() {
    ...
    sendAsync(sql).then((words_pre_arr) => {
          ...
          words_post_rF_obj = sortPropertyData(words_pre_rF_obj);

          var numUpdatedWords_ppa = 0;
          for (var w=0;w<numWords;w++) {
              var nextWord = words_pre_arr[w];
              var nextWord_rawFile_str = nextWord.rawFile;
              var nextWord_rawFile_obj = JSON.parse(nextWord_rawFile_str);
          ...
          <>
            <fieldset className="mainBody" >
                ...
                <div className="mainPanel" >
                    ...
                    <div class="h2">Update propertyData</div>
                    <br/>
                    ...
                    <div style={{display:"inline-block"}} id="numUpdatedWordsContainer_ppa" >numUpdatedWordsContainer_ppa</div>
                    <br/>
