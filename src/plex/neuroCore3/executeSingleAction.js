        ...
        case "a-a-u1n-validation":
            ...
            try {
                ...
                for (var a=0;a<aParentJSONSchemaSequence.length;a++) {
                    ...
                    var aConceptGraphDefaultProperties = window.ipfs.neuroCore.subject.oMainSchemaForConceptGraph.conceptGraphData.defaultPropertyDescriptors
            ...
            try {
                ...
                if (nF_pendingDeletion == false) {
                        ...
                        if ( (nF_propertyType=="string") || (nF_propertyType=="integer") || (nF_propertyType=="boolean") ) {
                            ...
                            oRFL.updated[nF_slug] = oNodeFrom;
                            window.ipfs.neuroCore.oRFL.updated[nF_slug] = oNodeFrom;
                        }
                ...
                window.ipfs.neuroCore.oRFL.updated[nF_slug] = oNodeFrom;
                oRFL.updated[nT_slug] = oNodeTo;
                window.ipfs.neuroCore.oRFL.updated[nT_slug] = oNodeTo;
            } catch (err) {
...
oRFL.updated.mainSchemaForConceptGraph = oMainSchemaForConceptGraph;
        ...
        case "a-c-c1n-createjsonschema":
            ...
            try {
                ...
                oRFL.updated[node_slug] = oNode;
                window.ipfs.neuroCore.oRFL.updated[node_slug] = oNode;
...
// window.ipfs.neuroCore.oRFL.updated[mainSchemaForConceptGraph_slug] = MiscFunctions.cloneObj(oMSFCG);
            } catch (err) {
...
oRFL.updated[nT_slug] = oNodeTo;
    ...
    for (var x=0;x<aNews.length;x++) {
        ...
        var newNeuroCore3UniqueIdentifier = actionSlug + "_" + nextNew_slug + "_" + x + "_" + nc2CycleNumber + "_" + singlePatternNumber + "_" + singleActionNumber;

        window.ipfs.neuroCore.engine.oRecordOfUpdates[newNeuroCore3UniqueIdentifier] = {}
        window.ipfs.neuroCore.engine.oRecordOfUpdates[newNeuroCore3UniqueIdentifier].old = {};
        window.ipfs.neuroCore.engine.oRecordOfUpdates[newNeuroCore3UniqueIdentifier].new = oWord_new;
        var infoHTML = "";
        infoHTML += "<div>";
            infoHTML += newNeuroCore3UniqueIdentifier + "<br>";
            infoHTML += " <div class='doSomethingButton_small makeNewNeuroCore3WordButton' style='background-color:white;' ";
            infoHTML += " data-newuniqueidentifier='"+newNeuroCore3UniqueIdentifier+"' ";
            infoHTML += " data-slug='"+nextNew_slug+"' ";
            infoHTML += " >";
            infoHTML += "CREATE";
            infoHTML += "</div>";
            infoHTML += "<div data-updateuniqueidentifier='"+newNeuroCore3UniqueIdentifier+"' class='newNeuroCore3UniqueIdentifier' style='display:inline-block;border-left:5px;' >";
        ...
        if (executeChanges=="yes") {
            ...
            window.ipfs.neuroCore.engine.changesMadeYetThisSupercycle = true;
            window.ipfs.neuroCore.engine.changesMadeYetThisCycle = true;
    ...
    for (var x=0;x<aUpdates.length;x++) {
        ...
        if (sWord_current != sWord_updated) {
            ...
            window.ipfs.neuroCore.engine.oRecordOfUpdates[updateUniqueIdentifier] = {}
            window.ipfs.neuroCore.engine.oRecordOfUpdates[updateUniqueIdentifier].old = MiscFunctions.cloneObj(oWord_current);
            window.ipfs.neuroCore.engine.oRecordOfUpdates[updateUniqueIdentifier].new = MiscFunctions.cloneObj(oWord_updated);
            var infoHTML = "";
            infoHTML += "<div>";
                infoHTML += updateUniqueIdentifier + "<br>";
                infoHTML += "<div class='doSomethingButton_small updateNeuroCore3WordButton' ";
                infoHTML += " data-updateuniqueidentifier='"+updateUniqueIdentifier+"' ";
                infoHTML += " data-slug='"+nextUpdate_slug+"' ";
                infoHTML += " >";
                infoHTML += "UPDATE";
                infoHTML += "</div>";
                infoHTML += "<div data-updateuniqueidentifier='"+updateUniqueIdentifier+"' class='actionNeuroCore3UpdatingWord' style='display:inline-block;border-left:5px;' >";
    ...
    if (addToQueue) {
        ...
        // (via aPats = window.ipfs.neuroCore.engine.oPatternsTriggeredByAction[actionSlug];)
        if (!auxAssistedQueue) {
            var aPats = window.ipfs.neuroCore.engine.oPatternsTriggeredByAction[actionSlug];
            ...
            for (var p=0;p<aPats.length;p++) {
                ...
                var oPat = MiscFunctions.cloneObj(window.ipfs.neuroCore.engine.oRFL.current[nextPat_slug]);
                ...
                if (!window.ipfs.neuroCore.engine.oPatternsWithAuxiliaryDataQueue.hasOwnProperty(nextPat_slug)) {
                    window.ipfs.neuroCore.engine.oPatternsWithAuxiliaryDataQueue[nextPat_slug] = [];
                }
                ...
                if (!isAPDP) {
                    window.ipfs.neuroCore.engine.oPatternsWithAuxiliaryDataQueue[nextPat_slug].push(oAPD)
                }
            }
        }
    }
...
export const addPatternsWithAuxiliaryPatternDataToQueue = (actionSlug,oAuxiliaryPatternData) => {
    var action_wordSlug = window.ipfs.neuroCore.engine.oMapPatternNameToWordSlug[actionSlug];
    var oAct = window.ipfs.neuroCore.engine.oRFL.current[action_wordSlug];
    var sAuxiliaryPatternData = JSON.stringify(oAuxiliaryPatternData);
    if (oAct.actionData.hasOwnProperty("secondaryPatterns")) {
        ...
        for (var s=0;s<aSets.length;s++) {
            ...
            var oNextSet = window.ipfs.neuroCore.engine.oRFL.current[nextSet_slug];
        ...
        for (var s=0;s<aIndividualPatterns.length;s++) {
            ...
            var oNextPattern = window.ipfs.neuroCore.engine.oRFL.current[nextPattern_wordSlug]
