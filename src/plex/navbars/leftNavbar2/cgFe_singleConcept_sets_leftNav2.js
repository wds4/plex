        ...
        return (
          <>
            <div className="leftNav2Panel_NeuroCore" >
                ...
                <NavLink className="leftNav2Button" activeClassName="active" to='/ConceptGraphsFrontEndSetsMainPage/current'>Sets Main Page</NavLink>
                <NavLink className="leftNav2Button" activeClassName="active" to='/ConceptGraphsFrontEndMakeNewSet/current'>Make New Set</NavLink>
            </div>
