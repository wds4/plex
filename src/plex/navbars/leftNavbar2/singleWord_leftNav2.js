      ...
      <>
        <div className="leftNav2Panel_NeuroCore" >
            <div className="leftNavBarBackBox">
                ...
                <NavLink className="leftNav2BackButton" activeClassName="active" to='/AllWordsTable_fast'>All Words (current concept graph )</NavLink>
            </div>
            ...
            <br/>
            <NavLink className="leftNav2Button" activeClassName="active" to='/SingleWordGeneralInfo/current'>General Info</NavLink>
        </div>
