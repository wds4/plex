...
export default class LeftNavbar2_Gun extends React.Component {
  render() {
    return (
      <>
        <div className="leftNav2Panel_Plex" >
            ...
            <center>GUN</center>
            <br/>
            <NavLink className="leftNav2Button" activeClassName="active" to='/GunGeneralInfo'>GUN General Info</NavLink>
        </div>
