        ...
        case "a-a-u1n-validation":
            ...
            try {
                ...
                for (var a=0;a<aParentJSONSchemaSequence.length;a++) {
                    ...
                    var oParent = oRFL.subject.oRFL.current[nextPJSchema_slug];
                    ...
                    var aConceptGraphDefaultProperties = oRFL.subject.oMainSchemaForConceptGraph.conceptGraphData.defaultPropertyDescriptors
