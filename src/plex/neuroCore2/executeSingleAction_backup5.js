...
if (!alreadyCreated) {
    ...
    if (!candidateRole5) {
        ...
        var newSubset_word_slug = "setFor_"+role4_concept_plural+"_organizedBy_"+role1_concept_singular;
...
oRFL.updated[node_slug] = oNode;
    ...
    for (var x=0;x<aNews.length;x++) {
        ...
        console.log("nextNew_slug: "+nextNew_slug+"; oWord_new: "+JSON.stringify(oWord_new,null,4))
