    ...
    switch (actionSlug) {
        ...
        case "a-c-c1n-createschema":
            ...
            try {
                ...
                // common to all specialNode types
                console.log("a-c-c1n-createschema; oNode: "+JSON.stringify(oNode,null,4))
                var sCurrConceptSingular = oNode.conceptData.name.singular;
                var sCurrConceptPlural = oNode.conceptData.name.plural;
                var oNewWord = await MiscFunctions.createNewWordByTemplate(newWordWordType)
        ...
        case "a-c-u1n-updatemainschemaforconceptgraph":
            ...
            try {
                ...
                console.log("updatemainschemaforconceptgraph; concept_slug: "+concept_slug)
                console.log("updatemainschemaforconceptgraph; oMainSchemaForConceptGraph_current: "+JSON.stringify(oMainSchemaForConceptGraph,null,4))
                ...
                // window.neuroCore.oRFL.updated[mainSchemaForConceptGraph_slug] = oMainSchemaForConceptGraph;
                console.log("updatemainschemaforconceptgraph; oMainSchemaForConceptGraph_updated: "+JSON.stringify(oMainSchemaForConceptGraph,null,4))
        ...
        case "a-a-umn-populatespecificinstances":
            ...
            try {
                ...
                console.log("a-a-umn-populatespecificinstances; governingConcept_slug: "+governingConcept_slug)
                var oGoverningConcept = NeuroCoreFunctions.fetchNewestRawFile(governingConcept_slug,oRFL)
                console.log("a-a-umn-populatespecificinstances; oGoverningConcept: "+JSON.stringify(oGoverningConcept,null,4))
...
const addPatternsToQueue = (actionSlug,plexNeuroCore) => {
    ...
    if (oAct.actionData.hasOwnProperty("secondaryPatterns")) {
        ...
        var aSets = oAct.actionData.secondaryPatterns.sets;
        ...
        var aIndividualPatterns = oAct.actionData.secondaryPatterns.individualPatterns;
