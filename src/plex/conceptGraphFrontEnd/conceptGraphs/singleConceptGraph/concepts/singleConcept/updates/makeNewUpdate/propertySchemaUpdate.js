...
export default class ConceptGraphsFrontEndSingleConceptMakeNewPropertySchemaUpdate extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            ...
            <>
                <fieldset className="mainBody" >
                    ...
                    <div className="mainPanel" >
                        ...
                        <div class="h4">Make New Property Schema Update for Single Concept</div>
                    </div>
                </fieldset>
            </>
        );
