...
export default class ConceptGraphsFrontEndSingleConceptMakeNewMainSchemaUpdate extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            ...
            <>
                <fieldset className="mainBody" >
                    ...
                    <div className="mainPanel" >
                        ...
                        <div class="h4">Make New Main Schema Update for Single Concept</div>
