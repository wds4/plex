...
export default class ConceptGraphsFrontEndSingleConceptGraphUpdateProposalsVisualizationMainPage extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            ...
            <>
                <fieldset className="mainBody" >
                    ...
                    <div className="mainPanel" >
                        ...
                        <div class="h2">Visualization of Update Proposals: Landing Page</div>
                    </div>
                </fieldset>
            </>
        );
