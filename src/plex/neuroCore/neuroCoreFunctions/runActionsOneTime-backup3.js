        ...
        case "A.c.u1n.makeSuperset":
            ...
            try {
                ...
                if (oNode.hasOwnProperty("wordTypeData")) {
                    ...
                    // delete the following - this was test to see whether it was possible to make a new word
    ...
    jQuery.each( oS1nPatternQueue, async function( pattern, aAuxiliaryData ) {
        ...
        for (var p=0;p<numAuxData;p++) {
            ...
            for (var a=0;a<numInducedActions;a++) {
                ...
                var oRawFileLookupBa = MiscFunctions.cloneObj(await executeSingleAction(nextAction,oNextAuxData,oRawFileLookupB));
                ...
                await updateRawFile(oRawFileLookupBa.updated,oRawFileLookup.current,oRawFileLookupBa.new);
            }
        }
    });
