...
function makeTable(tableName,dDataSet) {
    ...
    jQuery('#table_conceptGraphPattern_s1n tbody').on('click', 'td.details-control', function () {
...
export default class TableForPatternsSingleNode extends React.Component {
    ...
    componentDidMount() {
        jQuery(".mainPanel").css("width","calc(100% - 400px)");
        ...
        sendAsync(sql).then((result) => {
            ...
            for (var r=0;r<numRows;r++) {
                ...
                var oPatternData = {};
                oPatternData.pathname = "/NeuroCoreViewEditPatternSingleNode/"+nextRow_patternName;
                // oPatternData.pathname = "/NeuroCoreViewEditPatternSingleNode/"+nextRow_id;
                oPatternData.sqlid = 'linkFrom_'+nextRow_id;
                oPatternData.name = nextRow_patternName;
                this.state.patternLinks.push(oPatternData)
                this.forceUpdate();

                var nextRow_patternName_x = nextRow_patternName.replaceAll(".","-").toLowerCase();
                exportListHTML += nextRow_patternName;
                exportListHTML += "<br>"+nextRow_patternName_x;
        ...
        jQuery(".restrictByOpCodeBButton").click(function(){
            ...
            jQuery('#searchDiv_patternName').val(opCodeB).change();
        });
            ...
            <>
                <fieldset className="mainBody" >
                    ...
                    <div className="mainPanel" >
                        ...
                        <div class="h2">Table for Patterns: Single Node</div>
                        ...
                        <div className="tableContainer" style={{width:"99%",overflowY:"scroll"}} >
                            ...
                            <br/>
                            <table id="table_conceptGraphPattern_s1n" className="display" style={{color:"black",width:"95%"}} >
                                <thead>
                                    <tr>
                                        <th></th>
                                        <th>r</th>
