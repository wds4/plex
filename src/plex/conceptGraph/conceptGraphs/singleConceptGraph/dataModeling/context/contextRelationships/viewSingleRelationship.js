...
export default class ViewSingleContextRelationship extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            ...
            <>
                <fieldset className="mainBody" >
                    ...
                    <div className="mainPanel" >
                        ...
                        <div class="h2">View Single context to context Relationship (isAChildContextOf)</div>
