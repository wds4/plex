...
export default class ViewSingleSchemaOrgRelationship extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            ...
            <>
                <fieldset className="mainBody" >
                    ...
                    <div className="mainPanel" >
                        ...
                        <div class="h2">View Single Schema.org type to type Relationship (isAChildTypeOf)</div>
