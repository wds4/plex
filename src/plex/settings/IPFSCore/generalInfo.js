...
import LeftNavbar2 from '../../navbars/leftNavbar2/ipfsCore_leftNav2';

// import * as IPFS from 'ipfs-core'
// 1 Dec 22: cannot get ipfs-core to work
...
const fooFxn1 = async () => {
    ...
    console.log("fooFxn1 ipfs_core_version: "+version)

    /*
    const oIpfsID = await ipfs.id();
    const myPeerID = oIpfsID.id;
    console.log("fooFxn1 ipfs_core_myPeerID: "+myPeerID)
    */
}

export default class IPFSCoreGeneralInfo extends React.Component {
    constructor(props) {
        super(props);
        this.state = {}
    }
            ...
            <>
                <fieldset className="mainBody" >
                    ...
                    <div className="mainPanel" >
                        <div className="h2">IPFS Core: General Info (not the same node as IPFS Desktop)</div>
